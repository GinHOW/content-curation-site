...
export const works2025 = [
  {
    ...
    images: [
      ...
      { filename: "01-jiejie-02.gif" },
      { filename: "01-jiejie-03.gif" }
    ]
  },
  {
    id: "headline",
    ...
    images: [
      ...
      { filename: "02-headline-02.gif" },
      { filename: "02-headline-03.gif" }
    ]
  },
  {
    id: "northward-river",
    name: "北去的河",
    nameEn: "The Northward River",
    topic: "90年代国企改革与尺度",
    descriptionZh: [
    ...
    authors: {
      image: "03-northward-river-authors.png",
      students: ["周袁伊", "彭冠宇"]
    },
    images: [
      { filename: "03-northward-river-01.gif" },
      { filename: "03-northward-river-02.gif" },
      { filename: "03-northward-river-03.gif" }
    ]
  },
  {
    id: "chess-box",
    name: "棋盒：手提箱里的博物院",
    nameEn: "Museum in Valise",
    topic: "国际象棋",
    descriptionZh: [
    ...
    authors: {
      image: "04-chess-box-authors.png",
      students: ["谭闰潆", "叶书伶", "毛璐琰"]
    },
    images: [
  ...
  },
  {
    id: "threshold",
    name: "阈限 0.05mm",
    nameEn: "Threshold 0.05mm",
    topic: "钥匙与精密",
    descriptionZh: [
      "本次展览以「精密与阈限」为叙事核心，其视觉系统本身即是观念的呈现。",
      "从每把钥匙所关联的核心意象中提炼出基础图形，并以银色细线精准勾勒钥匙齿部轮廓，呼应0.05mm的尺度与阈值。与之呼应的数字「1、2、3」被转化为锁孔形态，直观构建篇章逻辑。",
      "此理念延伸至空间。",
    ...
    descriptionEn: [
      ...
      "Basic graphics are extracted from the core imagery associated with each key, and the outlines of the key teeth are precisely delineated with fine silver lines, echoing the 0.05mm scale and threshold. The corresponding numbers \"1, 2, 3\" are transformed into keyhole shapes, visually constructing the logical flow of the exhibition.",
    ...
    authors: {
      image: "05-threshold-authors.png",
      students: ["顾佳辉", "甘梓辰"]
    },
    images: [
  ...
  },
  {
    id: "four-hat-act",
    name: "四重帽剧",
    nameEn: "The Four Hat Act",
    topic: "帽子",
    descriptionZh: [
      "本展以「帽子」为线索，探讨其材质、重量与背后隐含的文化与社会意义。",
      "博伊斯说：「艺术在于赋予事物以第二重重量：它既是物质的，又是象征的。」基于此，本展以「轻」与「重」为思辨的两极，通过不同的帽子构建出四重剧场——「轻之轻、轻之重、重之轻、重之重」。它们既非固定的物理量，也非单一的价值判断，而是在社会、文化与感知层面不断流动的意义形态。在这流动与变化的帽剧中，我们在思考的不仅是物的轻重，更是意义在时间与意识中的漂移。"
    ],
    descriptionEn: [
    ...
    authors: {
      image: "06-four-hat-act-authors.png",
      students: ["孙平", "蔡咏烨"]
    },
    images: [
  ...
  },
  {
    ...
    authors: {
      image: "08-why-we-look-authors.png",
      students: ["张羽桐", "施雨欣"]
    },
    images: [
  ...
  },
  {
    id: "black-chamber",
    name: "黑色信箱",
    nameEn: "The Black Chamber",
    topic: "信箱",
    descriptionZh: [
      "如今走在城市街头，曾经承载情感与信息的信箱已不复往日。当信箱不再等待回音，它是什么？是街角的失效空间，还是安放「投递」这一行为本身的纯粹容器？街头那些静立的信箱，内里塞满广告或已成空壳。它们曾是连接世界的节点，如今却是被遗忘的失效空间。",
    ...
    authors: {
      image: "09-black-chamber-authors.png",
      students: ["许佳仪", "陈姿言"]
    },
    images: [
